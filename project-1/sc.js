window.addEventListener('load', () => {
    ...
    form.addEventListener('submit', (e) => {
        e.preventDefault();                                  //prevents the refresh on submitting.
...
let savedItems = JSON.parse(localStorage.getItem('savedItem'))
if (savedItems === null) {
    taskList = [];
} else {
    taskList = savedItems;
...
taskList.push(task)
localStorage.setItem('savedItem', JSON.stringify(taskList))
